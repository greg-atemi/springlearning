...
class OrderControllerTest {
    ...
    void PUT_order_ShouldReturn200_WhenUpdated() throws Exception {
        ...
        when(orderService.updateOrderById(
                eq(1),
                any(CreateOrderDTO.class)))
                .thenReturn(mockOrder);
    ...
    @Test
    void POST_updateOrderStatus_ShouldReturn200_WhenUpdated()
            throws Exception {
        ...
        when(orderService.updateOrderStatus(
                any(UpdateOrderStatusDTO.class)))
                .thenReturn(mockOrder);
    ...
    @Test
    void DELETE_order_ShouldReturn200_WhenDeleted()
            throws Exception {
